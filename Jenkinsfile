                        ...
                        if (nodeLabel == 'agent') {
                            node('agent') {
                                if (isUnix()) {
                                    ...
                                    bat "py script.py --user_messages ${params.USER_MESSAGES} --ai_responses ${params.AI_RESPONSES} --validation_errors ${params.VALIDATION_ERRORS} --cta_left ${params.CTA_LEFT} --session_time ${params.SESSION_TIME}"
                                }
                            }
                        } else {
                            node {
